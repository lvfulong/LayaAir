...
#include <Bindings/EditBox/WinCtrl.h>
...
namespace laya
{
    ...
    */
    ...
    {
        LONG_PTR udata = GetWindowLongPtr(hWnd,GWLP_USERDATA);
        winWindows* pWnd = reinterpret_cast<winWindows*>(udata);
        if (pWnd == nullptr)
            return 1;
        LRESULT  lRet = 1; 
