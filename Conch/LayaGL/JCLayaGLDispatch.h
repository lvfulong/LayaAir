...
namespace laya
{
    ...
    public:
        ...
        static JCLayaGL*       ms_pLayaGL;      ///<ȫ�ֵ�LayaGL
};
}
//------------------------------------------------------------------------------
