...
namespace laya
{
    ...
    public:
        ...
        typedef std::vector<std::shared_ptr<JCImage>>                   VectorImage;
        ...
        typedef std::map<int, std::shared_ptr<JCImage>>                 MapImage;
    ...
    public:
        ...
        */
        ...
        void setImage( int nID,std::shared_ptr<JCImage> pImage );

        bool deleteImage( int nID );
        
        void clearAllImage();

        std::shared_ptr<JCImage> getImage( int nID );
