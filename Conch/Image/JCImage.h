...
namespace laya
{
    ...
    */
    ...
    public:
		static void premultiplyPixels(const GLubyte* inPixels, GLubyte* outPixels, int byteLength, GLenum type, GLenum format);
        static bool premultiplyAlpha( BitmapData* pBitmapData );
		static void flipY(GLenum type, GLenum format, GLsizei width, GLsizei height, void* pixels);
    public:
        double             m_nTouchTime;
