...
EMSCRIPTEN_BINDINGS(physx_joint) {
    ...
    class_<PxJoint>("PxJoint")
            ...
            .function_optional_override("setLocalPose",
            ...
            .function_optional_override("setConstraintFlag", optional_override([](PxJoint &joint, int flag, bool value) {
            ...
            .function_optional_override("setUUID", optional_override([](PxJoint &joint, uint32_t uuid) {
                          auto ptr = malloc(sizeof(uint32_t));
                          memcpy(ptr, &uuid, sizeof(uint32_t));
                          joint.userData = ptr;
            }))
            .function_optional_override("getUUID", optional_override([](PxJoint &joint) {
    ...
    class_<PxSphericalJoint, base<PxJoint>>("PxSphericalJoint")
            .function_optional_override("setHardLimitCone", optional_override([](PxSphericalJoint &joint, PxReal yLimitAngle,
                                                               PxReal zLimitAngle, PxReal contactDist) {
                          joint.setLimitCone(PxJointLimitCone(yLimitAngle, zLimitAngle, contactDist));
                      }))  // ✅
            .function_optional_override("setSoftLimitCone", optional_override([](PxSphericalJoint &joint, PxReal yLimitAngle,
            ...
            .function_optional_override("setSphericalJointFlag", optional_override([](PxSphericalJoint &joint, PxReal flag, bool value) {
    ...
    class_<PxRevoluteJoint, base<PxJoint>>("PxRevoluteJoint")
            .function_optional_override("setHardLimit", optional_override([](PxRevoluteJoint &joint, PxReal lowerLimit, PxReal upperLimit,
                                                           PxReal contactDist) {
                          joint.setLimit(PxJointAngularLimitPair(lowerLimit, upperLimit, contactDist));
                      }))  // ✅
            .function_optional_override("setSoftLimit", optional_override([](PxRevoluteJoint &joint, PxReal lowerLimit, PxReal upperLimit,
            ...
            .function_optional_override("setRevoluteJointFlag", optional_override([](PxRevoluteJoint &joint, PxReal flag, bool value) {
    ...
    class_<PxDistanceJoint, base<PxJoint>>("PxDistanceJoint")
            ...
            .function_optional_override("setDistanceJointFlag", optional_override([](PxDistanceJoint &joint, PxReal flag, bool value) {
    ...
    class_<PxPrismaticJoint, base<PxJoint>>("PxPrismaticJoint")
            .function_optional_override("setHardLimit", optional_override([](PxPrismaticJoint &joint, PxTolerancesScale &scale,
            ...
            .function_optional_override("setSoftLimit", optional_override([](PxPrismaticJoint &joint, PxReal lowerLimit,
            ...
            .function_optional_override("setPrismaticJointFlag", optional_override([](PxPrismaticJoint &joint, PxReal flag, bool value) {
    ...
    class_<PxD6Joint, base<PxJoint>>("PxD6Joint")
            .function_optional_override("setMotion", optional_override([](PxD6Joint &joint, int axis, int type) {
                          joint.setMotion(PxD6Axis::Enum(axis), PxD6Motion::Enum(type));
                      }))  // ✅
            .function_optional_override("setDistanceLimit",
            ...
            .function_optional_override("setLinearLimit", optional_override([](PxD6Joint &joint, int axis, PxReal lowerLimit,
            ...
            .function_optional_override("setTwistLimit",
            ...
            .function_optional_override("setSwingLimit",
            ...
            //           }))  // ✅
            .function_optional_override("setDrive", optional_override([](PxD6Joint &joint,int index,PxReal stiffness,PxReal damping,PxReal forceLimit,PxReal flag) {
            ...
            .function_optional_override("setDrivePosition", optional_override([](PxD6Joint &joint, const PxVec3 &pos, const PxQuat &rot) {
