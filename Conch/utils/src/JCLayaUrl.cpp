...
namespace laya{
	...
	const char* JCUrl::getProtocolString(){
		...
		case laya::JCUrl::file:
			return "file:";
			break;
        case laya::JCUrl::wxfile:
            return "wxfile:";
            break;
		case laya::JCUrl::wxblob:
			return "wxblob:";
			break;
		default:
			return "unk:";
	...
	void JCUrl::parseScheme(const char*& p_pszData){
        ...
        else if ((pcur[0] == 'w' || pcur[0] == 'W') && (pcur[1] == 'x' || pcur[1] == 'X') && (pcur[2] == 'f' || pcur[2] == 'F') && (pcur[3] == 'i' || pcur[3] == 'I') && (pcur[4] == 'l' || pcur[4] == 'L') && (pcur[5] == 'e' || pcur[5] == 'E')) {
            //m_Protocol.st=0; m_Protocol.len=4;
            m_nProto = wxfile;
            p_pszData += 6;
		}
		else if ((pcur[0] == 'w' || pcur[0] == 'W') && (pcur[1] == 'x' || pcur[1] == 'X') && (pcur[2] == 'b' || pcur[2] == 'B') && (pcur[3] == 'l' || pcur[3] == 'L') && (pcur[4] == 'o' || pcur[4] == 'O') && (pcur[5] == 'b' || pcur[5] == 'B')) {
			//m_Protocol.st=0; m_Protocol.len=4;
			m_nProto = wxblob;
			p_pszData += 6;
		}
