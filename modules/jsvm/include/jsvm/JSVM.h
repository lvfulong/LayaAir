...
/*JSVM_EXTERN*/ jsvm_status jsvm_create_env(jsvm_vm vm, size_t propertyCount,
                                            const jsvm_property_descriptor *properties, jsvm_env *result);
...
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_string_latin1(jsvm_env env, jsvm_value value, char *buf, size_t bufsize,
                                                         size_t *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_create_string_utf16(jsvm_env env, const char16_t *str, size_t length,
                                                     jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_string_utf16(jsvm_env env, jsvm_value value, char16_t *buf, size_t bufsize,
                                                        size_t *result);
...
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_string_utf8(jsvm_env env, jsvm_value value, char *buf, size_t bufsize,
                                                       size_t *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_adjust_external_memory(jsvm_env env, int64_t changeInBytes, int64_t *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_cb_info(jsvm_env env, jsvm_callback_info cbinfo, size_t *argc, jsvm_value *argv,
                                             jsvm_value *thisArg, void **data);
/*JSVM_EXTERN*/ jsvm_status jsvm_set_named_property(jsvm_env env, jsvm_value object, const char *utf8name,
                                                    jsvm_value value);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_named_property(jsvm_env env, jsvm_value object, const char *utf8name,
                                                    jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_has_named_property(jsvm_env env, jsvm_value object, const char *utf8name,
                                                    bool *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_new_target(jsvm_env env, jsvm_callback_info cbinfo, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_wrap(jsvm_env env, jsvm_value jsObject, void *nativeObject, jsvm_finalize finalizeCb,
...
/*JSVM_EXTERN*/ jsvm_status jsvm_create_reference(jsvm_env env, jsvm_value value, uint32_t initialRefcount,
                                                  jsvm_ref *result);
...
/*JSVM_EXTERN*/ jsvm_status jsvm_new_instance(jsvm_env env, jsvm_value constructor, size_t argc, const jsvm_value *argv,
                                              jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_define_class(jsvm_env env, const char *utf8name, size_t length,
                                              jsvm_callback constructor, size_t propertyCount,
                                              const jsvm_property_descriptor *properties, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_call_function(jsvm_env env, jsvm_value recv, jsvm_value func, size_t argc,
                                               const jsvm_value *argv, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_create_function(jsvm_env env, const char *utf8name, size_t length, jsvm_callback cb,
...
/*JSVM_EXTERN*/ jsvm_status jsvm_create_typedarray(jsvm_env env, jsvm_typedarray_type type, size_t length,
                                                   jsvm_value arraybuffer, size_t byteOffset, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_create_dataview(jsvm_env env, size_t length, jsvm_value arraybuffer, size_t byteOffset,
                                                 jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_arraybuffer_info(jsvm_env env, jsvm_value arraybuffer, void **data,
                                                      size_t *byteLength);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_typedarray_info(jsvm_env env, jsvm_value typedarray, jsvm_typedarray_type *type,
                                                     size_t *length, void **data, jsvm_value *arraybuffer,
                                                     size_t *byteOffset);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_dataview_info(jsvm_env env, jsvm_value dataview, size_t *bytelength, void **data,
                                                   jsvm_value *arraybuffer, size_t *byteOffset);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_global(jsvm_env env, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_set_instance_data(jsvm_env env, void *data, jsvm_finalize finalizeCb,
                                                   void *finalizeHint);
...
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_bigint_int64(jsvm_env env, jsvm_value value, int64_t *result,
                                                        bool *lossless);
/*JSVM_EXTERN*/ jsvm_status jsvm_create_bigint_uint64(jsvm_env env, uint64_t value, jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_bigint_uint64(jsvm_env env, jsvm_value value, uint64_t *result,
                                                         bool *lossless);
...
/*JSVM_EXTERN*/ jsvm_status jsvm_get_named_property(jsvm_env env, jsvm_value object, const char *utf8name,
                                                    jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_create_external(jsvm_env env, void *data, jsvm_finalize finalizeCb, void *finalizeHint,
                                                 jsvm_value *result);
/*JSVM_EXTERN*/ jsvm_status jsvm_get_value_external(jsvm_env env, jsvm_value value, void **result);
/*JSVM_EXTERN*/ jsvm_status jsvm_add_finalizer(jsvm_env env, jsvm_value jsObject, void *finalizeData,
...
/*JSVM_EXTERN*/ jsvm_status jsvm_open_inspector(jsvm_env env, int port);
/*JSVM_EXTERN*/ jsvm_status jsvm_wait_for_debugger(jsvm_env env, bool breakNextLine);
/*JSVM_EXTERN*/ jsvm_status jsvm_close_inspector(jsvm_env env);
#endif