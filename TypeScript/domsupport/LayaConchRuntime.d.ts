...
interface  conch_FileReaderWX {
	download(param: any):void;
	new():conch_FileReader;
}
declare var FileReaderWX:conch_FileReaderWX;
...
declare class _layagl{
    ...
    setMainContextSize(width:number, hegiht:number);
}
declare var layagl:_layagl;

declare class _webglPlus{
...
declare var webglPlus:_webglPlus;
...
/*interface _conchTextCanvas {
    ...
    measureChar(unicode:number):any;
    _getTextBitmapData(sText:string, color:number, borderSize:number, borderColor:number):any;
...
interface conch {
    ...
    setZipPackage(zip: ZipFile): void;
    /**获得缓存路径 */
    getCachePath():string;
    /**从assets中读取文件内容 */
    ...
    registerFont(family:string,pathOrData:string|ArrayBuffer):string|null;
...
//declare var _conchTextCanvas:_conchTextCanvas;
