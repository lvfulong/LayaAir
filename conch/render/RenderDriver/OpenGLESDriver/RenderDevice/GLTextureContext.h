...
namespace laya
{
	...
	public:
		...
		virtual GLESInternalTex* createTextureInternal(TextureDimension dimension, int width, int height, TextureFormat format, bool gengerateMipmap, bool sRGB);
		virtual void setTextureImageData(GLESInternalTex* texture, JCImage* source/*HTMLImageElement | HTMLCanvasElement | ImageBitmap*/, bool premultiplyAlpha, bool invertY);
		virtual void setTexturePixelsData(GLESInternalTex* texture, char* source, int sourceBytes, bool premultiplyAlpha, bool invertY);
        virtual void setTexture3DImageData(GLESInternalTex* texture, const std::vector<JSImage*>& sources, int depth, bool premultiplyAlpha, bool invertY) {assert(0);};
        virtual void setTexture3DPixelsData(GLESInternalTex* texture, char* source, int sourceBytes, int depth, bool premultiplyAlpha, bool invertY) { assert(0);};
        virtual void setTexture3DSubPixelsData(GLESInternalTex* texture, char* source, int mipmapLevel, bool generateMipmap, int xOffset, int yOffset, int zOffset, int width, int height, int depth, bool premultiplyAlpha, bool invertY) { assert(0);};
        virtual void initVideoTextureData(GLESInternalTex* texture);
		virtual void setTextureSubPixelsData(GLESInternalTex* texture, char* source, int mipmapLevel, bool generateMipmap, int xOffset, int yOffset, int width, int height, bool premultiplyAlpha, bool invertY);
        ...
        virtual void setupRendertargetTextureAttachment(GLESInternalRT* renderTarget, std::shared_ptr<GLESInternalTex> texture);
		virtual void bindoutScreenTarget();
		virtual void unbindRenderTarget(GLESInternalRT* renderTarget);
		virtual GLESInternalTex* createRenderTextureInternal(TextureDimension dimension, int width, int height, RenderTargetFormat format, bool generateMipmap, bool sRGB);
		virtual GLESInternalTex* createRenderTextureCubeInternal(TextureDimension dimension, int size, RenderTargetFormat format, bool generateMipmap, bool sRGB);
		...
		virtual void setCubeImageData(GLESInternalTex* texture, const std::vector<JSImage*>& sources, bool premultiplyAlpha, bool invertY);
		virtual void setCubePixelsData(GLESInternalTex* texture, const std::vector<char*>& source, bool premultiplyAlpha, bool invertY);
		virtual void setCubeSubPixelData(GLESInternalTex* texture, const std::vector<char*>& source, int mipmapLevel, bool generateMipmap, int xOffset, int yOffset, int width, int height, bool premultiplyAlpha, bool invertY);
