...
namespace laya {
    ...
    void GLESRender3DProcess::renderCameraForwardPass(RTRenderContext3D* context, GLESForwardAddRP* passInfo, std::vector<GLESBaseRenderNode*> renderNodeList, uint32_t count){
        //先渲染ShadowTexture
