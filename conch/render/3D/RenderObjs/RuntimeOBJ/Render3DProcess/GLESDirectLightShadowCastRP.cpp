...
void GLESDirectLightShadowCastRP::update(RTRenderContext3D*context)
{
...
void GLESDirectLightShadowCastRP::render(RTRenderContext3D* context, std::vector<GLESBaseRenderNode *> &list,
                                         uint32_t count)
{
