...
namespace laya
{
	...
	void ShaderInstance::uploadRenderStateBlendDepthByShader(ShaderData* shaderDatas)
	{
		...
		bool* a = renderState->depthWrite != nullptr ? renderState->depthWrite : (bool*)shaderDatas->getData<int32_t>(Shader3D::DEPTH_WRITE);
		bool* depthWrite = a != nullptr ? a : RenderState::Default.depthWrite;
		RenderStateContext::setDepthMask(*depthWrite);
		int32_t* b = renderState->depthTest != nullptr ? renderState->depthTest : shaderDatas->getData<int32_t>(Shader3D::DEPTH_TEST);
		...
		bool* c = renderState->stencilWrite != nullptr ? renderState->stencilWrite : (bool*)shaderDatas->getData<int32_t>(Shader3D::STENCIL_WRITE);
		bool* stencilWrite = c != nullptr ? c : RenderState::Default.stencilWrite;

		int32_t* d = renderState->stencilTest != nullptr ? renderState->stencilTest : shaderDatas->getData<int32_t>(Shader3D::STENCIL_TEST);
		int32_t* stencilTest = d != nullptr ? d : RenderState::Default.stencilTest;
		RenderStateContext::setStencilMask(stencilWrite);
		if (stencilWrite) {
			Vector3* e = renderState->stencilOp != nullptr ? renderState->stencilOp : shaderDatas->getData<Vector3>(Shader3D::STENCIL_Op);
			Vector3* stencilOp = e != nullptr ? e : RenderState::Default.stencilOp;

			RenderStateContext::setstencilOp((StencilOperation)stencilOp->x, (StencilOperation)stencilOp->y, (StencilOperation)stencilOp->z);
		}
		if (*stencilTest == RenderState::STENCILTEST_OFF) {
			RenderStateContext::setStencilTest(false);
		}
		else {
			int32_t* f = renderState->stencilRef != nullptr ? renderState->stencilRef : shaderDatas->getData<int32_t>(Shader3D::STENCIL_Ref);
		...
		{
			int32_t* a = renderState->blendEquation != nullptr ? renderState->blendEquation : shaderDatas->getData<int32_t>(Shader3D::BLEND_EQUATION);
			int32_t* blendEquation = a != nullptr ? a : RenderState::Default.blendEquation;

			int32_t* b = renderState->srcBlend != nullptr ? renderState->srcBlend : shaderDatas->getData<int32_t>(Shader3D::BLEND_SRC);
			int32_t* srcBlend = b != nullptr ? b : RenderState::Default.srcBlend;

			int32_t* c = renderState->dstBlend != nullptr ? renderState->dstBlend : shaderDatas->getData<int32_t>(Shader3D::BLEND_DST);
		...
		{
			int32_t* a = renderState->blendEquationRGB != nullptr ? renderState->blendEquationRGB : shaderDatas->getData<int32_t>(Shader3D::BLEND_EQUATION_RGB);
			int32_t* blendEquationRGB = a != nullptr ? a : RenderState::Default.blendEquationRGB;

			int32_t* b = renderState->blendEquationAlpha != nullptr ? renderState->blendEquationAlpha : shaderDatas->getData<int32_t>(Shader3D::BLEND_EQUATION_ALPHA);
			int32_t* blendEquationAlpha = b != nullptr ? b : RenderState::Default.blendEquationAlpha;

			int32_t* c = renderState->srcBlendRGB != nullptr ? renderState->srcBlendRGB : shaderDatas->getData<int32_t>(Shader3D::BLEND_SRC_RGB);
			int32_t* srcRGB = c != nullptr ? c : RenderState::Default.srcBlendRGB;

			int32_t* d = renderState->dstBlendRGB != nullptr ? renderState->dstBlendRGB : shaderDatas->getData<int32_t>(Shader3D::BLEND_DST_RGB);
			int32_t* dstRGB = d != nullptr ? d : RenderState::Default.dstBlendRGB;

			int32_t* e = renderState->srcBlendAlpha != nullptr ? renderState->srcBlendAlpha : shaderDatas->getData<int32_t>(Shader3D::BLEND_SRC_ALPHA);
			int32_t* srcAlpha = e != nullptr ? e : RenderState::Default.srcBlendAlpha;

			int32_t* f = renderState->dstBlendAlpha != nullptr ? renderState->dstBlendAlpha : shaderDatas->getData<int32_t>(Shader3D::BLEND_DST_ALPHA);
	...
	void ShaderInstance::uploadRenderStateBlendDepthByMaterial(ShaderData* shaderDatas) {
		...
		case RenderState::BLEND_ENABLE_SEPERATE:
		{
			...
			blendEquationAlpha = blendEquationAlpha != nullptr ? blendEquationAlpha : RenderState::Default.blendEquationAlpha;
