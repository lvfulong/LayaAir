...
namespace laya{
    ...
    void Render3DProcess::renderCameraForwardPass(RenderContext3D* context, RenderForwardADDPass* passInfo, std::vector<BaseRenderNode*> renderNodeList, uint32_t count){
        //先渲染ShadowTexture
