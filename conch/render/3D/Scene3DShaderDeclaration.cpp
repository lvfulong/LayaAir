...
void Scene3DShaderDeclaration::__init__()
{
    ...
    Scene3DShaderDeclaration::SHADERDEFINE_SHADOW_SPOT_SOFT_SHADOW_LOW = LayaGL::m_pWebglEngine->getDefineByName("SHADOW_SPOT_SOFT_SHADOW_LOW");
    Scene3DShaderDeclaration::SHADERDEFINE_SHADOW_SPOT_SOFT_SHADOW_HIGH = LayaGL::m_pWebglEngine->getDefineByName("SHADOW_SPOT_SOFT_SHADOW_HIGH");
}
}; // namespace laya