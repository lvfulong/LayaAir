...
-(void)showAlert
{
    ...
    if( m_vSaveInfo.size() >0 )
    {
        ...
        //NSString* nsMessage = [[NSString alloc] initWithCString:sInfo.c_str() encoding:NSUTF8StringEncoding];
        NSString* nsMessage = [[NSString alloc] initWithBytes:sInfo.c_str() length: sInfo.size() encoding:NSUTF8StringEncoding];
