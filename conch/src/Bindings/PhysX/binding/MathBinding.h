...
EMSCRIPTEN_BINDINGS(physx_math) {
    ...
    register_vector<int>("Vector_Int32");
    register_vector<PxU8>("Vector_Int8");
...
template <> struct is_wrapped_class<physx::PxVec3> : std::false_type
{
};
template <> struct is_value_object<physx::PxQuat> : std::true_type
{
};
template <> struct is_wrapped_class<physx::PxQuat> : std::false_type
{
};

template <> struct is_value_object<physx::PxContactPairPoint> : std::true_type
{
};

template <> struct is_wrapped_class<physx::PxContactPairPoint> : std::false_type
{
};

template <> struct is_value_object<physx::PxExtendedVec3> : std::true_type
{
};
template <> struct is_wrapped_class<physx::PxExtendedVec3> : std::false_type
{
};

template <> struct is_value_object<physx::PxTransform> : std::true_type
{
};
template <> struct is_wrapped_class<physx::PxTransform> : std::false_type
{
};

template <> struct is_value_object<LayaTriggerInfo> : std::true_type
{
};
template <> struct is_wrapped_class<LayaTriggerInfo> : std::false_type
{
};

template <> struct is_value_object<LayaContactPairInfo> : std::true_type
{
};
template <> struct is_wrapped_class<LayaContactPairInfo> : std::false_type
{
};

template <> struct is_value_object<LayaQuaryResult> : std::true_type
{
};
template <> struct is_wrapped_class<LayaQuaryResult> : std::false_type
{
};

template <> struct is_value_object<physx::PxFilterData> : std::true_type
{
};
template <> struct is_wrapped_class<physx::PxFilterData> : std::false_type
{
};
