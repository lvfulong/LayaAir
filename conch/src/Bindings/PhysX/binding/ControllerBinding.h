...
EMSCRIPTEN_BINDINGS(physx_controller) {
    ...
    class_<PxControllerDesc>("PxControllerDesc")
            ...
            .function_optional_override("setreportCallBackBehavior",optional_override([](PxControllerDesc &desc) {
            ...
            .function_optional_override("setNonWalkableMode", optional_override([](PxControllerDesc &desc, int mode) {
                           desc.nonWalkableMode = PxControllerNonWalkableMode::Enum(mode);
                      }))  // ✅
            .function_optional_override("setMaterial", optional_override([](PxControllerDesc &desc, PxMaterial *material) {
...
//             .allow_subclass<ControllerHitReport>("ControllerHitReport");
    class_<PxController>("PxController")
            .function_optional_override("release", optional_override([](PxController &ctrl) {
            ...
            .function_optional_override("isSetControllerCollisionFlag",
            ...
            .function_optional_override("move", optional_override([](PxController &controller, const PxVec3 &disp, PxF32 minDist,
            ...
            .function_optional_override("setNonWalkableMode", optional_override([](PxController &controller, int mode) {
            ...
            /** PxCapsuleController ✅ */
            .function_optional_override("setRadius", optional_override([](PxController &ctrl, PxF32 radius) {
                          static_cast<PxCapsuleController *>(&ctrl)->setRadius(radius);
                      }))  // ✅
            .function_optional_override("setHeight", optional_override([](PxController &ctrl, PxF32 height) {
                          static_cast<PxCapsuleController *>(&ctrl)->setHeight(height);
                      }))  // ✅
            .function_optional_override("setClimbingMode", optional_override([](PxController &ctrl, int mode) {
                          return static_cast<PxCapsuleController *>(&ctrl)->setClimbingMode(
                                  PxCapsuleClimbingMode::Enum(mode));
                      }))  // ✅
                           /** PxBoxController ✅ */
            .function_optional_override("setHalfHeight", optional_override([](PxController &ctrl, PxF32 radius) {
                          static_cast<PxBoxController *>(&ctrl)->setHalfHeight(radius);
                      }))  // ✅
            .function_optional_override("setHalfSideExtent", optional_override([](PxController &ctrl, PxF32 height) {
                          static_cast<PxBoxController *>(&ctrl)->setHalfSideExtent(height);
                      }))  // ✅
            .function_optional_override("setHalfForwardExtent", optional_override([](PxController &ctrl, PxF32 height) {
                          static_cast<PxBoxController *>(&ctrl)->setHalfForwardExtent(height);
                      }))
            .function_optional_override("setUUID", optional_override([](PxController &ctrl, uint32_t uuid) {
            ...
            .function_optional_override("setPushForce",optional_override([](PxController &ctrl, PxF32 force) {
                        controllerUserData* userData = ( controllerUserData*)ctrl.getUserData();
                        userData->pushforce = force;
            }))
            .function_optional_override("setShapeID",optional_override([](PxController &ctrl, uint32_t uuid) {
                        PxRigidDynamic *actor = ctrl.getActor();
                        PxShape *shape;
                        actor->getShapes(&shape, 1);
            ...
            .function_optional_override("setEventFilter",optional_override([](PxController &ctrl, PxU16 filter) {
                        controllerUserData* userData = ( controllerUserData*)ctrl.getUserData();
