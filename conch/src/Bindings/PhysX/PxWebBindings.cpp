...
//     class_<PxPvdTransport>("PxPvdTransport");
    ...
    class_<PxPhysics>("PxPhysics")
            ...
            .function_optional_override("createFixedJoint",
                      ...
                      allow_raw_pointers())  // ✅
            .function_optional_override("createRevoluteJoint",
                      optional_override([](PxPhysics &physics, PxRigidActor *actor0, const PxVec3 &localPosition0,
                                           const PxQuat &localRotation0, PxRigidActor *actor1,
                                           const PxVec3 &localPosition1, const PxQuat &localRotation1) {
                      ...
                      allow_raw_pointers())  // ✅
            .function_optional_override("createSphericalJoint",
                      optional_override([](PxPhysics &physics, PxRigidActor *actor0, const PxVec3 &localPosition0,
                                           const PxQuat &localRotation0, PxRigidActor *actor1,
                                           const PxVec3 &localPosition1, const PxQuat &localRotation1) {
                      ...
                      allow_raw_pointers())  // ✅
            .function_optional_override("createDistanceJoint",
                      optional_override([](PxPhysics &physics, PxRigidActor *actor0, const PxVec3 &localPosition0,
                                           const PxQuat &localRotation0, PxRigidActor *actor1,
                                           const PxVec3 &localPosition1, const PxQuat &localRotation1) {
                      ...
                      allow_raw_pointers())  // ✅
            .function_optional_override("createPrismaticJoint",
                      optional_override([](PxPhysics &physics, PxRigidActor *actor0, const PxVec3 &localPosition0,
                                           const PxQuat &localRotation0, PxRigidActor *actor1,
                                           const PxVec3 &localPosition1, const PxQuat &localRotation1) {
                      ...
                      allow_raw_pointers())  // ✅
            .function_optional_override("createD6Joint",
                      optional_override([](PxPhysics &physics, PxRigidActor *actor0, const PxVec3 &localPosition0,
                                           const PxQuat &localRotation0, PxRigidActor *actor1,
                                           const PxVec3 &localPosition1, const PxQuat &localRotation1) {
