...
namespace laya 
{
    ...
    void JsFile::exportJS(Context& context)
    {
        ...
        class_binding_file.property("enableCache", &JsFile::getEnableCache, &JsFile::setEnableCache);
        class_binding_file.constructor<>();
        class_binding_file.constructor<const char *>();
        class_binding_file.constructor<const char *, const char *>();
        context.class_("File", class_binding_file);
    }
}
