...
void JSConchConfig::setScreenOrientation(int p_nOrientation)
    ...
    {
#ifdef OS_IOS
        return "ios-conch6-release-3.2.2";
#elif OS_ANDROID
        return "android-conch6-release-3.2.2";
#elif OS_WINDOWS
        return "window-conch6-release-3.2.2";
#elif OS_OHOS
        return "ohos-conch6-release-3.2.2";
#elif OS_LINUX
        return "linux-conch6-release-3.2.2";
#endif
    }
	//机型
