...
namespace laya
{
    ...
    bool JCLayaGLDispatch::dispatchScriptCmd(JCCommandEncoderBuffer& pRenderCmd)
    {
        ...
        {
            &JCLayaGLDispatch::_layaGL_uniformMatrix2fvEx,			
            &JCLayaGLDispatch::_layaGL_uniformMatrix3fvEx,			
            &JCLayaGLDispatch::_layaGL_uniformMatrix4fvEx,			
            &JCLayaGLDispatch::_layaGL_addShaderUniform,			
			&JCLayaGLDispatch::_layaGL_uploadShaderUniforms,		
            &JCLayaGLDispatch::_layaGL_uploadShaderUniformsData,
            &JCLayaGLDispatch::_layaGL_empty,
            &JCLayaGLDispatch::_layaGL_empty,				        
            &JCLayaGLDispatch::_layaGL_empty,				        
			&JCLayaGLDispatch::_layaGL_empty,						
			&JCLayaGLDispatch::_layaGL_empty,					    
            ...
            &JCLayaGLDispatch::_layaGL_empty,//64
            &JCLayaGLDispatch::_layaGL_empty,//65
            &JCLayaGLDispatch::_layaGL_empty,//66
            &JCLayaGLDispatch::_layaGL_empty,//67
            &JCLayaGLDispatch::_layaGL_empty,//68
            &JCLayaGLDispatch::_layaGL_empty,//69
            &JCLayaGLDispatch::_layaGL_empty,//70
            &JCLayaGLDispatch::_layaGL_empty,//71
            ...
            &JCLayaGLDispatch::_layaGL_stencilOpSeparate,
            ...
            &JCLayaGLDispatch::_layaGL_uniform2fv,
            ...
            &JCLayaGLDispatch::_layaGL_uniform4iv,
            ...
            &JCLayaGLDispatch::_layaGL_vertexAttrib3f,
	...
	void JCLayaGLDispatch::_layaGL_clearBufferfi(JCCommandEncoderBuffer& layaGLCmd)
	{
		CMD_iifi* cmd = layaGLCmd.popp<CMD_iifi>();
		ms_pLayaGL->clearBufferfi(cmd->a, cmd->b, cmd->c, cmd->d);
	}
	void JCLayaGLDispatch::_layaGL_bindBufferRange(JCCommandEncoderBuffer& layaGLCmd)
	{
		CMD_iiiii* cmd = layaGLCmd.popp<CMD_iiiii>();
		ms_pLayaGL->bindBufferRange(cmd->i, cmd->j, cmd->k, cmd->l, cmd->m);
	}
	void JCLayaGLDispatch::_layaGL_bindBufferBase(JCCommandEncoderBuffer& layaGLCmd)
	{
		CMD_iii* cmd = layaGLCmd.popp<CMD_iii>();
		ms_pLayaGL->bindBufferBase(cmd->i, cmd->j, cmd->k);
	}
    ...
    void JCLayaGLDispatch::_layaGL_texImage2D(JCCommandEncoderBuffer& layaGLCmd)
    {
        ...
        {
            CanvasRenderingContext2D* context2d = CanvasRenderingContext2D::get(cmd->n);
            if (context2d)
            {
                //if (ms_pLayaGL->m_bPremultiplyAlpha)
                //{
                 //   pImage->premultiplyAlpha();
                //}
                int width = context2d->getBitmapData().m_nWidth;
                int height = context2d->getBitmapData().m_nHeight;
                char* pBufferData = (char*)context2d->getBitmapData().m_pImageData;
                if (pBufferData && width > 0 && height > 0)
                {
                    unsigned char* outData = nullptr;
                    size_t outDataLen = 0;
                    convertRGBA8888ToFormat((unsigned char*)pBufferData, width * height * 4, cmd->k, &outData, &outDataLen);
                    ms_pLayaGL->texImage2D(cmd->i,cmd->j,cmd->k,width,height,0,cmd->l,cmd->m, outData);
                    if (outData != (unsigned char*)pBufferData)
                    {
                       delete[] outData;
    ...
    void JCLayaGLDispatch::_layaGL_texSubImage2D(JCCommandEncoderBuffer& layaGLCmd)
    {
        ...
        {
            CanvasRenderingContext2D* context2d = CanvasRenderingContext2D::get(cmd->g);
            if (context2d)
            {
                //if (ms_pLayaGL->m_bPremultiplyAlpha)
                //{
                ...
                if (pBufferData && width > 0 && height > 0)
                {
                    unsigned char* outData = nullptr;
                    size_t outDataLen = 0;
                    convertRGBA8888ToFormat((unsigned char*)pBufferData, width * height * 4, cmd->e, &outData, &outDataLen);
                    ms_pLayaGL->texSubImage2D(cmd->a, cmd->b, cmd->c, cmd->d, width, height, cmd->e, cmd->f, outData);
                    if (outData != (unsigned char*)pBufferData)
                    {
                        delete[] outData;
