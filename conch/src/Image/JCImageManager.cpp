...
namespace laya
{
    ...
    void JCImageManager::setImage(int nID, std::shared_ptr<JCImage> pImage)
    {
        bool bSucess = true;
    ...
    std::shared_ptr<JCImage> JCImageManager::getImage(int nID)
    {
