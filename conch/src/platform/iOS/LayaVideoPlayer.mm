...
static UIView* ms_pCurParentView;
static float ms_rentinaValue;

@implementation LayaVideoPlayer

+(void)setCurParentView:(UIView *)view withRetianValue: (float) rentinaValue {
...
-(id)initWithParentView:(UIView*) view withRenderTargetType:(RenderTargetType) renderTargetType {
    self->m_pView = view;
