...
import static com.open.camera.CameraView.BUTTON_STATE_BOTH;
import static com.open.camera.CameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.open.camera.CameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    public CaptureButton(Context context, int size) {
        ...
        button_state = BUTTON_STATE_ONLY_CAPTURE;  //初始化按钮为可录制可拍照
