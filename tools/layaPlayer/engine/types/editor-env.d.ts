...
declare global {
    export namespace IEditorEnv {
        ...
        export namespace IHandleUtils {
             ...
             * @param prefab select prefab
             * @returns select sprite
             */
            function getSprite3D(x: number, y: number, prefab?: boolean): Laya.Sprite3D;
        ...
        export interface IBuildTask {
            ...
            minifyJsFile(filePath: string, mangleOptions?: { keep_fnames?: boolean, keep_classnames?: boolean }, sourcemap?: boolean): Promise<string>;
        ...
        export interface INativeTools {
            ...
            installCli(pkgName: string, options?: IExecOptions): Promise<ExecResult>;
        ...
        export interface ITemplateUtils {
            renderTemplate(content: string, templateArgs?: Record<string, any>): string;

            renderTemplateFile(filePath: string, templateArgs?: Record<string, any>): void;

            renderTemplateFileAsync(filePath: string, templateArgs?: Record<string, any>): Promise<void>;
        }
        ...
        const utils: ICryptoUtils & INativeTools & IUUIDUtils & IObjectUtils & IUtils & INetUtils & ITemplateUtils;
